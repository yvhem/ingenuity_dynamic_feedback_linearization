function animation_2d(xi, t, trajectory_type, params, target_fps)
    % inputs
    if nargin < 5 || isempty(target_fps)
        target_fps = 30; 
    end
    ...
    fig = figure('Name', 'Simulation Animation', 'Color', 'w', 'Position', [100, 100, 1400, 900]);
    ...
    plot(NaN,NaN, 'b', 'LineWidth', 2, 'DisplayName', 'Actual'); % Legend dummy
